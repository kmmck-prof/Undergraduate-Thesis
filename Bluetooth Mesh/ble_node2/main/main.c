                                             ...
                                             esp_ble_mesh_model_cb_param_t *param)
{
    ...
    case ESP_BLE_MESH_MODEL_OPERATION_EVT:
        ...
        if (param->model_operation.opcode == ESP_BLE_MESH_VND_MODEL_OP_SEND) {
            ...
            snprintf(data_payload, 500, "{\"COraw\":\"%.2f\",\"COindex\":\"%.0f\",\"CO2raw\":\"%.2f\",\"CO2index\":\"%.0f\",\"NO2raw\":\"%.2f\",\"NO2index\":\"%.0f\",\"PM25raw\":\"%.2f\",\"PM25index\":\"%.0f\",\"PM10raw\":\"%.2f\",\"PM10index\":\"%.0f\",\"VOCraw\":\"%.2f\",\"VOCindex\":\"%.0f\",\"T\":\"%.2f\",\"RH\":\"%.2f\",\"Lat\":\"%.7f\",\"Long\":\"%.7f\",\"speed\":\"%.2f\",\"source\":\"Node 4\",\"local_time\":\"%s\",\"type\":\"data\"}",co,co_score,co2,co2_score,no2,no2_score,pm25,pm25_score,pm10,pm10_score,voc,voc_score,temp,rh,lat_deg,long_deg,speed_kmh,Current_Date_Time);
			sd_card_write();
            esp_err_t err = esp_ble_mesh_server_model_send_msg(&vnd_models[0],
                    param->model_operation.ctx, ESP_BLE_MESH_VND_MODEL_OP_STATUS,
//                    sizeof(tid), (uint8_t *)&tid);
